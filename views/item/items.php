        ...
        <div id="myModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div id="msg"></div>
              <form method="POST" action="../../controllers/ItemController.php?action=add_item" 
              onsubmit="return validateForm()">
                ...
                <div class="form-group">
                  ...
                  <span title="This will provide information to alert admin before 3 months the product has been expired"><i class="glyphicon glyphicon-question-sign help-icon"></i></span></label>
